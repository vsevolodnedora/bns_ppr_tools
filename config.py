...
debug = False # Don't touch this

#### ==== where to output result (make 'simulation_name/' dir there first)
...
#### ==== where simulation data is i.e., 'simulation_name/' dir with data e.g., 'output-xxxx/' folders
