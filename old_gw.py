...
if __name__ == '__main__':
    ...
    parser.add_argument("-i", dest="simdir", required=False, default=None, help="path to collated data for sim")
    ...
    if glob_indir is None:
        ...
        if not os.path.isdir(glob_indir):
            raise IOError("Input directory : {} does not exists".format(glob_indir))
